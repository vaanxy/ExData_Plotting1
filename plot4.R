plot4 <- function () {
        ...
        par(mfrow = c(2,2))
        with(power_subset,plot(x = Datetime, y = Global_active_power, type = "l", ylab = "Global Active Power", xlab = ""))
        with(power_subset,plot(x = Datetime, y = Voltage, type = "l", ylab = "Voltage", xlab = "datetime"))
        ...
        with(power_subset,plot(x = Datetime, y = Global_reactive_power, type = "l", xlab = "datetime"))
        dev.off()
        print("plot success.")
}